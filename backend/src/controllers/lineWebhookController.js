  ...
  try {
    ...
    if (userResult.rows.length === 0) {
      ...
      await lineClient.replyMessage(event.replyToken, {
        type: 'text',
        text:
          '🔗 ยังไม่ได้เชื่อมกับ PixcelBOB\n\n' +
          '1) แตะลิงก์ด้านล่างเพื่อเปิด PixcelBOB ภายใน LINE\n' +
          '2) ทำตามขั้นตอน Login Google + เลือกโฟลเดอร์\n' +
          '3) กลับมาที่แชทนี้แล้วส่งรูปอีกครั้ง\n\n' +
          `${authUrl}`
      });
      return;
    }
